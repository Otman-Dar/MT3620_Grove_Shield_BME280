...
void* GroveTempHumiBaroBME280_Open(int i2cFd)
{
	...
	if (!GroveI2C_ReadReg8(this->I2cFd, BME280_ADDRESS, BME280_REG_CHIPID, &val8))
		return NULL;
	...
	if (!GroveI2C_ReadReg16(this->I2cFd, BME280_ADDRESS, BME280_REG_DIG_T1, &dig_T1))
		return NULL;
	...
	if (!GroveI2C_ReadReg16(this->I2cFd, BME280_ADDRESS, BME280_REG_DIG_P1, &dig_P1))
		return NULL;
